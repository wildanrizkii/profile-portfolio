              ...
              {mounted && (
                <div className="hidden md:block relative" ref={dropdownRef}>
                  <button
                    ...
                    className="rounded-full border-2 border-foreground bg-foreground text-background hover:bg-transparent hover:text-foreground flex h-8 px-3 items-center justify-center text-xs font-mono uppercase tracking-wider gap-1.5 cursor-none clickable font-semibold transition-colors duration-200"
                  >
                  ...
                  <AnimatePresence>
                    {dropdownOpen && (
                      <motion.div
                        ...
                        className="absolute right-0 mt-2 w-40 bg-background border-2 border-foreground rounded-xl shadow-md py-1 z-50 overflow-hidden origin-top-right"
                      >
                        <button
                          onClick={() => {
            ...
            <div className="text-left space-y-14">
              ...
              {mounted && (
                <motion.div
                  ...
                  className="block md:hidden relative mt-6"
                  ...
                  <AnimatePresence>
                    {mobileDropdownOpen && (
                      <motion.div
                        ...
                        exit={{ opacity: 0, y: -10, scale: 0.95 }}
                        transition={{ duration: 0.15, ease: "easeOut" }}
                        className="absolute left-0 mt-2 w-40 bg-background border-2 border-foreground rounded-xl shadow-md py-1 z-50 overflow-hidden origin-top-left"
                      >
                        <button
                          onClick={() => {
                            setAesthetic("original");
