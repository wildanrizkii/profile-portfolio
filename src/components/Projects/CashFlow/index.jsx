    ...
    >
      ...
      <div className="relative z-10">
        ...
        <motion.section
          ...
          variants={fadeIn}
        >
          <div className="relative rounded-3xl overflow-hidden border-2 border-neutral-200 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 min-h-[360px] md:min-h-[480px] p-8 flex flex-col justify-between">
            {/* Grid bg */}
            <div
