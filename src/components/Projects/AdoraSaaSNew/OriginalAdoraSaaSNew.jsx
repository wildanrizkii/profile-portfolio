...
const mockPrescriptions = [
  { name: "Amoxicillin 500mg", qty: "3├ù1", status: "Dispensed", statusColor: "text-emerald-400" },
  { name: "Paracetamol 500mg", qty: "3├ù1", status: "Dispensed", statusColor: "text-emerald-400" },
  { name: "Omeprazole 20mg", qty: "1├ù1", status: "Pending", statusColor: "text-amber-400" },
