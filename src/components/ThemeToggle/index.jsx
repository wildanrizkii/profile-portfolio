...
const ThemeToggle = ({ className }) => {
  ...
  return (
    ...
    >
      ...
      <Sun className="absolute h-6 w-6 transition-all duration-300 ease-out rotate-0 scale-100 opacity-100 dark:rotate-90 dark:scale-75 dark:opacity-0 text-foreground" />
    </button>
  );
};
